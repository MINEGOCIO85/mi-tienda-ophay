...
# 2. CSS: AJUSTE DE TAMAÑO PARA LEGIBILIDAD TOTAL
st.markdown("""
    <style>
    ...
    .plata-fuerte {
        ...
        -webkit-background-clip: text; -webkit-text-fill-color: transparent;
        font-weight: 900; 
        font-size: 1.1rem; /* TAMAÑO REDUCIDO PARA QUE QUEPA TODO */
...
with t[0]:
    ...
    st.markdown('<h2 class="oro" style="text-align:left;font-size:1.5rem;">ARIES LEO SAGI</h2>', unsafe_allow_html=True)
    ...
    st.markdown('<p class="h-dia" style="margin-top:15px;">FIN DE SEMANA</p><p class="plata-fuerte">UNA SEÑAL CLAVE APARECE EL DOMINGO. ESCUCHA TU INSTINTO ANTES DE ACTUAR.</p>', unsafe_allow_html=True)
    st.markdown('</div>', unsafe_allow_html=True)

with t[1]:
    st.markdown('<div class="box">', unsafe_allow_html=True)
    st.markdown('<h2 class="oro" style="text-align:left;font-size:1.5rem;">TAURO VIRGO CAPRI</h2>', unsafe_allow_html=True)
    ...
    st.markdown('<p class="h-dia" style="margin-top:15px;">FIN DE SEMANA</p><p class="plata-fuerte">LIMPIA TU HOGAR DE ENERGÍAS DENSAS. ES EL MOMENTO DE ATRAE ABUNDANCIA.</p>', unsafe_allow_html=True)
    st.markdown('</div>', unsafe_allow_html=True)

with t[2]:
    st.markdown('<div class="box">', unsafe_allow_html=True)
    st.markdown('<h2 class="oro" style="text-align:left;font-size:1.5rem;">GEMINIS LIBRA ACUA</h2>', unsafe_allow_html=True)
    ...
    st.markdown('<p class="h-dia" style="margin-top:15px;">FIN DE SEMANA</p><p class="plata-fuerte">UN ENCUENTRO CON ALGUIEN DEL PASADO TRAERÁ UNA OPORTUNIDAD QUE NO ESPERABAS.</p>', unsafe_allow_html=True)
    st.markdown('</div>', unsafe_allow_html=True)

with t[3]:
    st.markdown('<div class="box">', unsafe_allow_html=True)
    st.markdown('<h2 class="oro" style="text-align:left;font-size:1.5rem;">CANCER SCORP PISCIS</h2>', unsafe_allow_html=True)
    ...
    st.markdown('<p class="h-dia" style="margin-top:15px;">FIN DE SEMANA</p><p class="plata-fuerte">USA TU AMATISTA PARA PROTEGER TU CAMPO. FILTRA LAS ENERGÍAS EXTERNAS.</p>', unsafe_allow_html=True)
    st.markdown('</div>', unsafe_allow_html=True)
