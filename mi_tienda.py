...
# 2. CSS: ESTILO ORO Y PLATA REFINADO
st.markdown("""
    <style>
...
# 5. DESTINO SEMANAL TODOS LOS SIGNOS
...
with t[0]:
    ...
    st.markdown('<h2 class="oro" style="text-align:left;font-size:1.5rem;">ARIES • LEO • SAGITARIO</h2>', unsafe_allow_html=True)
...
with t[1]:
    ...
    st.markdown('<p class="h-dia" style="margin-top:15px;">FIN DE SEMANA</p><p class="plata-fuerte">LIMPIA TU HOGAR DE ENERGÍAS DENSAS. ES EL MOMENTO DE ATRAER ABUNDANCIA.</p>', unsafe_allow_html=True)
    st.markdown('</div>', unsafe_allow_html=True)

with t[2]:
    st.markdown('<div class="box">', unsafe_allow_html=True)
    st.markdown('<h2 class="oro" style="text-align:left;font-size:1.5rem;">GÉMINIS • LIBRA • ACUARIO</h2>', unsafe_allow_html=True)
...
with t[3]:
    st.markdown('<div class="box">', unsafe_allow_html=True)
    st.markdown('<h2 class="oro" style="text-align:left;font-size:1.5rem;">CÁNCER • ESCORPIO • PISCIS</h2>', unsafe_allow_html=True)
    st.markdown('<p class="h-dia">LUNES A MIÉRCOLES</p><p class="plata-fuerte">SUEÑOS MUY VÍVIDOS. TU VOZ INTERIOR MANDA HOY
