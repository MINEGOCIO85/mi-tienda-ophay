...
# ESTILO CORREGIDO PARA MÁXIMA LEGIBILIDAD
st.markdown("""
    <style>
    .main { background-color: #000000; color: #ffffff; }
    [data-testid="stAppViewContainer"] { background-color: #000000; }
    
    /* Títulos y Precios en Oro Brillante */
    h1, h3, .precio-oro { 
    ...
    /* Texto de descripción en BLANCO para que se lea bien */
    .descripcion-texto {
...
st.markdown("<p style='color: #d4af37;'>Alta Clarividencia & Boutique Esotérica</p>", unsafe_allow_html=True)
st.markdown("---")
...
with col1:
    ...
    st.markdown("<div class='descripcion-texto'>Lectura profunda para despejar dudas sobre tu futuro inmediato.</div>", unsafe_allow_html=True)
...
with col2:
    ...
    st.markdown("<div class='descripcion-texto'>Mazo de alta calidad con acabados dorados para coleccionistas.</div>", unsafe_allow_html=True)
...
with col3:
    ...
    st.markdown("<div class='descripcion-texto'>Piedra natural cargada bajo la luna para protección energética.</div>", unsafe_allow_html=True)
    st.link_button("COMPRAR", "https://wa.me/34684668398")

st.markdown("---")
st.markdown("<p style='text-align: center; color: #555555;'>OPHAY • MMXXVI | El destino no se espera, se construye.</p>", unsafe_allow_html=True)
