...
# 2. ESTILO MÍSTICO (Diseño Limpio y Oscuro)
st.markdown("""
    <style>
...
# 5. LISTADO DE PRODUCTOS (Líneas compactas para evitar errores)
draw_item("https://images.unsplash.com/photo-1572025442646-866d16c84a54?w=700", "LECTURA DEL DESTINO", "25", "Consulta profunda para desvelar tu camino sagrado.", "https://wa.me/34600000000")
