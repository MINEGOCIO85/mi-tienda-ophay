...
# 2. ESTILO CSS "TAROTOO STYLE" (Místico y Lujoso)
st.markdown("""
    <style>
...
# 5. LISTADO DE LOS 4 PRODUCTOS ESOTÉRICOS REALES

# 1. LECTURA: Un primer plano místico de cartas y una mano.
...
# 2. MAZO: El mazo clásico sobre una tela oscura y mística.
...
# 3. CRISTAL: Una amatista cruda con reflejos mágicos.
...
# 4. VELA: Una vela mística oscura encendida sobre una base de cobre.
draw_item("https://images.unsplash.com/photo-1601314167099-232775b3d6fd?w=800", 
          "VELA DE RITUAL", "12", "Luz y aroma para tus sesiones de meditación y claridad.", "https://wa.me/34600000000")
