...
# 5. LISTADO CON ENLACES DIRECTOS (Basado en tu lista de GitHub)
user = "MINEGOCIO85"
...
# PRODUCTO 3 (Cambiado a .png que es el que tienes subido)
draw_item(f"{base}/amatista.png", "AMATISTA SAGRADA", "15", "Energía pura bajo la luna llena.")
