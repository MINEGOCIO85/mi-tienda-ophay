...
# PRODUCTO 3: Dron (ENLACE NUEVO RESISTENTE)
col5, col6 = st.columns([1, 2])
with col5:
    # He cambiado a una foto de Pexels que tiene permisos abiertos
    st.image("https://images.pexels.com/photos/2050748/pexels-photo-2050748.jpeg?auto=compress&cs=tinysrgb&w=400", caption="Dron Explorer")
with col6:
