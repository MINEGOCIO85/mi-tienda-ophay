...
# 2. ESTILO MAESTRO (ORO, BLANCO Y PLATA)
st.markdown("""
<style>
...
.precio { font-family: 'Montserrat'; color: #f1c40f; font-size: 1.3rem; font-weight: 700; text-align: center; margin: 10px 0; }
...
# 4. PRODUCTOS (WHATSAPP DIRECTO SIN MENSAJE)
B = "https://raw.githubusercontent.com/MINEGOCIO85/mi-tienda-ophay/main/"
W = "https://wa.me/34684668398" # Enlace limpio sin texto
...
with c1:
    ...
    st.link_button("CONTACTAR POR WHATSAPP", W)
