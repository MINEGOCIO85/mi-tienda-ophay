...
# Estilo para que se vea mejor en móviles
...
with col1:
    st.image("https://images.unsplash.com/photo-1508685096489-7aac2968b244?w=400", caption="Smartwatch Ultra")
with col2:
...
with col3:
    st.image("https://images.unsplash.com/photo-1535016120720-40c646bebbfc?w=400", caption="Proyector 4K")
with col4:
...
with col5:
    st.image("https://images.unsplash.com/photo-1507500033025-502621ec3ca3?w=400", caption="Dron Explorer")
with col6:
