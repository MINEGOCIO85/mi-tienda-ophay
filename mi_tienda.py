...
.box{border:1px double #d4af37;padding:20px;margin-top:20px;text-align:center;background:#050505;min-height:150px;}
...
with r1:
    st.markdown("""<div class="box"><p class="oro">🌿 LAUREL</p><p class="txt">Quema laurel para limpiar.</p></div>""", unsafe_allow_html=True)
with r2:
    st.markdown("""<div class="box"><p class="oro">🧂 SAL</p><p class="txt">Vaso al hielo 9 dias.</p></div>""", unsafe_allow_html=True)
with r3:
    st.markdown("""<div class="box"><p class="oro">✨ CANELA</p><p class="txt">Sopla canela en tu puerta.</p></div>""", unsafe_allow_html=True)
